        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Make Bot Codes", url="https://t.me/botcodesforyou")],
                     [InlineKeyboardButton(text="🙋 Support Group", url="https://t.me/botcodesforyou"), InlineKeyboardButton(text="🔔 Updates", url="https://t.me/mhdfajisn")],
                     [InlineKeyboardButton(text="🔮Telegram Channel", url="https://t.me/botcodesforyou"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
